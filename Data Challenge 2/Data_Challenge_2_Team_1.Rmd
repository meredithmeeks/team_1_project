...
Following up on the randomForest algorithm aboe, we are creating a binary variable indicating whether any casualties (**anycasualties**) at all occured during a confrontation and then using a conditional logistic model to estimate the effect of involvement of particular law enforcement agencies and military forces on sustaining casualties in a confrontation in which the **municipal.police** was involved.
